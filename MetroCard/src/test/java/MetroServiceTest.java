import calc.WeekdayFareStrategy;
import calc.WeekendFareStrategy;
...
import pojo.CardTrx;
import pojo.SmartCard;
import pojo.Station;
import pojo.Traveller;
  ...
  public void testCardReport() throws Exception {
    ...
    assertThat("One of the Trx should be charged 35", trxs.toArray(new CardTrx[0]), hasItemInArray(new CustomMatcher<CardTrx>("Fare shall be 35") {
      ...
      public boolean matches(Object o) {
        ...
        return trx.getFare() == 35.0 && trx.getFareStrategyUsed() instanceof WeekdayFareStrategy
            && trx.getDistance() == 5;
      }
    }));
    ...
    assertThat("Other Trx should be charged 35", trxs.toArray(new CardTrx[0]), hasItemInArray(new CustomMatcher<CardTrx>("Fare shall be 35") {
      ...
      public boolean matches(Object o) {
        CardTrx trx = (CardTrx) o;
        return trx.getFare() == 22.0 && trx.getFareStrategyUsed() instanceof WeekendFareStrategy
            && trx.getDistance() == 4;
      }
    }));
  }
